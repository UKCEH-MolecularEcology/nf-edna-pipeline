process ECOLOGY_REPORT {
    ...
    # rmarkdown/knitr/ggplot2/dplyr/kableExtra/DT all ship pre-installed and
    # build-verified in this container image (see containers/ecology/Dockerfile)
    # -- load directly, no runtime install, no shared cache (see
    # ecology_alpha/main.nf for why that broke things).
